...
| --- | --- | --- |
| 🟢 ガン | 50G | バランス型・安価な連射砲 |
| 🟠 キャノン | 90G | 高威力・**範囲ダメージ**（群れに強い） |
| 🔵 フロスト | 70G | 低威力だが命中した敵を**減速** |
| 🟣 スナイパー | 110G | **超長射程・高威力**だが連射が遅い |
| 🩷 サポート | 80G | 攻撃しない補助塔。**射程内の味方タワーの連射速度を上げる**（範囲は薄いオーラ、バフ中の塔には▲印） |

各タワーは **Lv.3 まで強化**でき、威力・射程・連射（サポートはバフ量・射程）が上がります。売却すると投資額の 70% が戻ります。
