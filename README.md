...
- **各タワーは 1 種類につき 1 基まで**（設置済みの種別は「設置済」表示）。配置し直したいときは売却してから置き直します
- タワーは射程内の敵を自動で狙って攻撃します
- **設置済みのタワーをタップ**すると**強化／売却**パネルが開きます
